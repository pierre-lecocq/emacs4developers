...
- 1 [[#emacs-for-developers][Emacs for developers]]
    ...
    - 1.5 [[#the-basics][The basics]]
        - 1.5.1 [[#config-files][Config files]]
        - 1.5.2 [[#executing-commands][Executing commands]]
        - 1.5.3 [[#key-bindings][Key bindings]]
        - 1.5.4 [[#help][Help!]]
    - 1.6 [[#building-your-own-editor][Building your own editor]]
        - 1.6.1 [[#first-basic-configuration][First basic configuration]]
        - 1.6.2 [[#general-basic-configuration][General basic configuration]]
        - 1.6.3 [[#backup-files][Backup files]]
        - 1.6.4 [[#setting-up-the-locales][Setting up the locales]]
        - 1.6.5 [[#more-configuration][More configuration]]
        - 1.6.6 [[#modes][Modes]]
        - 1.6.7 [[#package-managers][Package managers]]
        - 1.6.8 [[#some-useful-packages][Some useful packages]]
    - 1.7 [[#setting-a-color-theme][Setting a color theme]]
        - 1.7.1 [[#font-settings][Font settings]]
    - 1.8 [[#coming-from-other-editors-ie-vim][Coming from other editors (i.e Vim)]]
    - 1.9 [[#emacs-as-a-file-manager][Emacs as a file manager]]
    - 1.10 [[#working-locally-vs-remotely][Working locally vs remotely]]
    - 1.11 [[#organize-your-work-write-papers-and-manage-your-agenda][Organize your work, write papers and manage your agenda]]
    - 1.12 [[#emails-in-emacs][Emails in Emacs]]
    - 1.13 [[#some-great-emacs-tips-and-tricks][Some great Emacs tips and tricks]]
- 2 [[#some-useful-readings-tutorials-and-demos][Some useful readings, tutorials and demos]]
- 3 [[#thanks][Thanks]]
- 4 [[#license][License]]
