...
Here are mine: (https://github.com/pierre-lecocq/emacs.d)

- The [[https://github.com/pierre-lecocq/emacs.d/blob/master/config/org/01-packages.org][packages]] I use
- The [[https://github.com/pierre-lecocq/emacs.d/blob/master/config/org/02-common.org][common]] configuration
- The [[https://github.com/pierre-lecocq/emacs.d/blob/master/config/org/03-modes.org][modes]] specific configuration
- The [[https://github.com/pierre-lecocq/emacs.d/blob/master/config/org/04-keybindings.org][keybindings]]
...
From now on, we will use /el-get/ to install packages.
