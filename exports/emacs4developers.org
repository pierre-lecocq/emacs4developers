...
- 4. [[#special-features][Special features]]
   - 4.1 [[#emacs-as-a-file-manager][Emacs as a file manager]]
   - 4.2 [[#working-locally-vs-remotely][Working locally vs remotely]]
   - 4.3 [[#organize-your-work-write-papers-and-manage-your-agenda][Organize your work, write papers and manage your agenda]]
   - 4.4 [[#emails-in-emacs][Emails in Emacs]]
   - 4.5 [[#some-great-emacs-tips-and-tricks][Some great Emacs tips and tricks]]
   - 4.6 [[#coming-from-other-editors-ie-vim][Coming from other editors (i.e Vim)]]
- 5. [[#readings-and-resources][Readings and resources]]
